...
_Per-company tone, style, do/don't and approved boilerplate (CHARTER.md §5). Built incrementally from
Minda's steer and existing company materials — see HI-3 in `open-issues.md`._

| Company | Status |
|---|---|
| Fishbone Construction Ltd | **Complete** (`Fishbone-Construction-Ltd.md`) — tagline, positioning, voice patterns, four real service lines, both process framings, an eight-project portfolio, confirmed logo files, and **confirmed final brand colours** (green `#74C800`, grey `#A8A8A8`, Minda 2026-09-19). No open gaps. |
...
| Fishbone Properties Ltd | **On hold (Minda, 2026-09-16)** — no current business need; not to be picked up proactively. Was already charter-flagged as a later addition, not the first batch |
